                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('saveTodo') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" name="name" value="{{ $todo->name }}" placeholder="Enter name">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="reminder_id" name="reminder_id">
                              ...
                              @foreach($reminders  as $reminder)
                                <option value="{{ $reminder->id }}" @if($reminder->id == $todo->reminder_id ) selected="selected" @endif >{{ $reminder->name }}</option>
                              @endforeach
                            </select>
                          </div>
                          <div class="form-row">
                            <div class="form-group col-md-6">
                              ...
                              <input type="date" name="start_date" value="{{ $todo->start_date }}" class="form-control" id="start_date">
                            ...
                            <div class="form-group col-md-6">
                              ...
                              <input type="date" name="end_date" value="{{ $todo->end_date }}" class="form-control" id="end_date">
