                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('saveUserData') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="email" name="email" value="{{ $userData->email }}" placeholder="Enter email">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="phone" name="phone" value="{{ $userData->phone }}" placeholder="Enter phone number">
                            @if ($errors->has('phone'))
